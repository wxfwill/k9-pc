...
class CarEnterListComponent extends Component{
	constructor(props){
  	...
  	requestList(params, callBack){
	    ...
	    httpAjax('post',config.apiUrl+'/api/hmInterface/queryExitInfo',{...params}).then((res)=>{
  	...
  	componentWillMount() {
		...
		let today = moment();
		let twoDayAge = moment(nowTime-24*60*60*1000*2);
		this.setState({
...
// WEBPACK FOOTER //
// ./src/components/admin/cardInfo/OutList.js