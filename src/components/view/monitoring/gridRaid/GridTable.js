...
const columns = [{
  ...
  key: 'patrolsPlace',
  render:(text)=>{
    return <span><img src={localSVG} alt="local_pic"/>{text}</span>
  }
},{
  title: '任务状态',
  dataIndex: 'taskState',
...
class GridTable extends React.Component {
  ...
  fetch(params = {pageSize:this.state.pageSize,currPage:this.state.currPage}){
    ...
    httpAjax('post',config.apiUrl+'/api/dailyPatrols/listDailyPatrols',{...params,...this.state.filter}).then((res)=>{
...
// WEBPACK FOOTER //
// ./src/components/view/monitoring/GridRaid/GridTable.js