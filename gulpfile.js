...
gulp.task('publish', () => {
  ...
  return gulp.src([gulpConfig.devServerSShConfig.uploadFile]).pipe(gulpSSH.dest(config.remotePath));
});
...
// gulp.task(
//   'default',
//   gulp.series('execSSHDelete', 'publish', 'execSSHBackup', 'reloadNginx', (done) => {
