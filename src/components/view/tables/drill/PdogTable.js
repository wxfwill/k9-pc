...
class DeployTable extends React.Component {
  ...
  fetch(params = {pageSize:this.state.pageSize,currPage:this.state.currPage}){
    ...
    httpAjax('post',config.apiUrl+'/api/dailyTrainRecord/list',{...params}).then((res)=>{
  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.changeLeft ? <VideoModal
          changeLeft={this.state.changeLeft}
          onCancel={this.handleCancel}
        /> : null}
         {this.state.locateFlag ? <LocateModal
          changeLeft={this.state.locateFlag}
