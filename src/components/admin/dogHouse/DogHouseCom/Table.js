...
class DogTable extends Component{
  ...
  fetch(params = {pageSize:this.state.pageSize,currPage:this.state.currPage}){
    ...
    httpAjax('post',config.apiUrl+'/api/dogRoom/listRoomData',{...params}).then((res)=>{
          ...
          return <div>
            ...
            >
              <Link to={{pathname:'/app/room/infoDetail', query: { Id: record.id,targetText:'查看' }}}>  
                 <span  style={{cursor: "pointer",color:'#1890ff'}} ><Icon type='eye' style={{margin:'0 10px', }} />查看</span></Link>
            </span>
