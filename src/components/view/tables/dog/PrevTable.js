...
class PrevTable extends React.Component {
  ...
  fetch(params = {pageSize:this.state.pageSize,currPage:this.state.currPage}){
    ...
    httpAjax('post',config.apiUrl+'/api/vaccineRecord/list',{...params}).then((res)=>{
  ...
  const columns = [{
    ...
    return (
      <div>
        ...
        {this.state.showDetail?<PrevDetailTable handleShow={this.handleShow.bind(this)} caption={this.state.detailTitle} changeLeft={this.state.changeLeft}/>:null}              
      </div>
    );
  }
}
