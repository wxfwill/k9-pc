  ...
  render() {
    ...
    const reproduceColumns = [
      ...
      },
      {
        ...
        key: 'id',
        render: (record, index) => {
          return index.femaleChlNumber + index.maleChlNumber;
        }
      },
      {
        title: '仔犬公母犬数',
        ...
        key: 'id',
        render: (record, index) => {
          return `${index.femaleChlNumber}公${index.maleChlNumber}母`;
        }
      },
      {
        title: '繁衍期',
                      ...
                      <div className="fold_info">
                        ...
                        <div className="fold_dec">
                          <div className="dec_content">
                            <span className="dec_label">
                              性别：{dogInfo.sex ? (dogInfo.sex == 1 ? '公' : '母') : ''}
                            </span>
                            <span className="dec_label">出生日期：{dogInfo.birthdayStr}</span>
                            <span className="dec_label">
                              训导员：{`${dogInfo.trainerName}-${dogInfo.trainerNumber}`}
                            </span>
                          </div>
                          <div className="dec_content">
                        ...
                        <div className="unfold_dec">
                          ...
                          <div className="dec_content">
                            ...
                            <span className="dec_label">
                              直系亲属：{`父：${dogInfo.fatherName}母：${dogInfo.motherName}`}
                            </span>
                          </div>
                          <div className="dec_content">
                            ...
                            <span className="dec_label">
                              体检表：
                              {dogInfo.medicalReportName == 'none' ? (
                                ''
                              ) : (
                                <a
                                  href={'/api/dog/dlmedicalReport?id=' + dogInfo.id}
                                  target="_blank"
                                  rel="noopener noreferrer">
                                  {dogInfo.medicalReportName}
                                </a>
                              )}
                            </span>
                            <span className="dec_label"></span>
                      ...
                      <Tabs.TabPane tab="血统图谱" key="1">
                        <div className="family_tree">
                          <div className="father_tree">
                            ...
                            <div className="tree_bg second_tree">
                              <span className="tree_bg_top second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[0] && treeList[0].fFather}
                              </span>
                              <span className="tree_bg_bot second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[0] && treeList[0].fMother}
                              </span>
                            </div>
                            <div className="tree_bg three_tree">
                              <span className="tree_bg_top second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[0] && treeList[0].mFather}
                              </span>
                              <span className="tree_bg_bot second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[0] && treeList[0].mMother}
                              </span>
                            </div>
                          </div>
                        </div>
                        <div className="family_tree">
                          <div className="father_tree">
                            ...
                            <div className="tree_bg second_tree">
                              <span className="tree_bg_top second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[1] && treeList[1].fFather}
                              </span>
                              <span className="tree_bg_bot second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[1] && treeList[1].fMother}
                              </span>
                            </div>
                            <div className="tree_bg three_tree">
                              <span className="tree_bg_top second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[1] && treeList[1].mFather}
                              </span>
                              <span className="tree_bg_bot second_tree_inner" style={{width: 'maxContent'}}>
                                {treeList[1] && treeList[1].mMother}
                              </span>
                            </div>
                          </div>
                        </div>
