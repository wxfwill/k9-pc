          ...
          <Card title={this.state.title}>
            <Collapse defaultActiveKey={['1','2']}>
                ...
                <Row gutter={24}>
                  <Col xxl={16} xl={24} lg={24} md={24} sm={24} xs={24} >
                      <div className='baseDataTable'>
                        ...
                        <Row >
                            <Col  span={6}>执行时间</Col>
                            <Col  span={6}>{detailData.excuteDate?moment(detailData.excuteDate).format('YYYY-MM-DD'):'--'}</Col>
                            <Col  span={6}>发布人</Col>
                            <Col  span={6}>{}</Col>                    
                        </Row>                                                                                                                     
                      </div>
              ...
              <Panel showArrow={false} header={this.checkHeader()} key="2">
                <Row gutter={24}>
                  <Col xxl={16} xl={24} lg={24} md={24} sm={24} xs={24} >
                        <Table loading={loading} columns={recordsColumns} dataSource={detailData.detailRecords}  pagination={false} bordered rowKey='id' />
                  </Col>
                </Row>
              </Panel>
            </Collapse>
