...
class WalkieTalkieMaterial extends Component {
  constructor(props) {
    super(props);
    this.state = {
      detailInfor: '',
                ...
                <table border="1" bordercolor="#E7E7E7" className="table-box mgt12">
                  <tbody className="no-wrap-th">
                    ...
                    <tr>
                      ...
                      <th>是否领取背夹</th>
                      <td>{detailInfor.backSplint}</td>
                    </tr>
                    <tr>
                      <th>对讲机编号</th>
                      <td colSpan="3">{detailInfor.interphoneNo && detailInfor.interphoneNo.split(',').join(' / ')}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
export default WalkieTalkieMaterial;
