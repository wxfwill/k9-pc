...
class DailyFeedTable extends React.Component{
	constructor(props){
  	...
  	fetch(params = {pageSize:this.state.pageSize,currPage:this.state.currPage}){
	    ...
	    httpAjax('post',config.apiUrl+'/api/feed/getDailyFeed',{...params}).then((res)=>{
	...
	render(){
		...
		return(
			<div>			
				...
				{showDetail ? <DailyFeedDetailTable  handleShow={this.handleShow} detailSource={detailSource} changeLeft={changeLeft} />  : ''}		
			</div>
		)
	}
}
