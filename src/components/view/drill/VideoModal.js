           ...
           <Card  
            ...
            <Card 
                ...
                bodyStyle={{padding: '15px 32px'}} >
                    ...
                    <Col span={12}><img style={{width:'100%',padding:12,minHeight: 300,maxHeight:440,border: '1px solid silver',borderBottom:0,borderRight:0}} src={one}/><Affix style={{ position: 'absolute', top: '8%', left: '80%'}}>{time}</Affix></Col>
                    <Col span={12}><img style={{width:'100%',padding:12,minHeight: 300,maxHeight:440,border: '1px solid silver'}} src={two}/><Affix style={{ position: 'absolute', top: '8%', left: '80%'}}>{time}</Affix></Col>
                    </Row>
                
                    <Row align='middle' type='flex'>
                    <Col span={12}><img style={{width:'100%',padding:12,minHeight: 300,maxHeight:440,border: '1px solid silver'}} src={three}/><Affix style={{ position: 'absolute', top: '8%', left: '80%'}}>{time}</Affix></Col>
                    <Col span={12}></Col>
                    </Row>
