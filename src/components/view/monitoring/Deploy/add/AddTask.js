...
const combatTypeList = [{ num: "", text: '请选择作战类型' }, { num: 1, text: '反恐处突' }, { num: 2, text: '突发事件' }, { num: 3, text: '侦查破案' }, { num: 4, text: '重点安保' }, { num: 5, text: '排练演练' }]
                ...
                >
                    ...
                    <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                      ...
                      <FormItem label={'作战区域'} {...secondLayout} hasFeedback>
                        {getFieldDecorator('taskCoord', {
                          ...
                          <Input placeholder="作战区域" disabled={true} addonBefore={<Icon type="plus" style={{ cursor: 'pointer' }} onClick={this.addCoord.bind(this)} />} />
                        )}
                      </FormItem>
                    ...
                    <Col xl={12} lg={12} md={24} sm={24} xs={24} >
                      <FormItem label={'作战人员'} {...secondLayout} hasFeedback >
                        {getFieldDecorator('userIds', {
                          ...
                          >
                            <Input placeholder="作战人员" value={this.state.peoValue} disabled={true} addonBefore={<Icon type="plus" style={{ cursor: 'pointer' }} onClick={this.addPeople.bind(this)} />} />
                          </Tooltip>
                        )}
                      </FormItem>
                    </Col>
                    <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                      <FormItem label={'作战类型'} {...secondLayout} hasFeedback>
                        {getFieldDecorator('combatType', {
                          ...
                          <Select placeholder="作战类型" onChange={(value) => { this.setState({ combatType: value }) }}>
                          
                            {
                              combatTypeList.map((item) => <Option key={item.num} value={item.num}>{item.text}</Option>)
                            }
                          </Select>
                        )}
                      </FormItem>
                  ...
                  <FormItem label={'作战内容'} {...firstLayout} hasFeedback>
                    {getFieldDecorator('taskContent', {
                      rules: [{ required: true, message: '请输入作战内容' },{ max: 1000, message: '作战内容长度不超过1000' }],
