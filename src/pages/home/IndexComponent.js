...
class IndexComponent extends Component{
  ...
  exitFull() {
	...
	render(){
        ...
        <Button onClick={this.showPandect.bind(this)} size='large' shape="circle"type="primary" style={{position:'absolute',top:'85px',right:'29px',zIndex:'9'}}><Icon type="arrows-alt" /></Button>
        <Row gutter={24}>
            ...
            <Card title="犬只总数统计" bordered={true} >
              <Row justify='space-between' className='num-total'>
                <Col md={{span:6}} sm={12} xs={24} >
                  ...
                  >
                    <p>
                    <span style={{fontSize:'35px'}}>297</span>头</p>
                  </Card>
                </Col>
                <Col md={{span:6,offset:3}} sm={12} xs={24} >
                  ...
                  >
                    <p>
                    <span style={{fontSize:'35px'}}>126</span>头</p>
                  </Card>
                </Col>
                <Col md={{span:6,offset:3}} sm={12} xs={24}>
                  <Card
                  ...
                  >
                    <p>
                    <span style={{fontSize:'35px'}}>26</span>头</p>
                  </Card>
                </Col>
              </Row>
            </Card>
            <Row gutter={24}>
              <Row gutter={24} >
                 <Col xl={24} lg={24} md={24} sm={24} xs={24} >
                  <RadioGroup defaultValue="a" size="large" style={{width:'100%',display:'flex',justifyContent:'space-around'}}>
                    <RadioButton style={{flex:1}} value="a"><Icon type="pie-chart" />犬只分布</RadioButton>
                    <RadioButton style={{flex:1}} value="b"><Icon type="wifi" />外勤巡逻</RadioButton>
                    <RadioButton style={{flex:1}} value="c"><Icon type="global" />网格化搜捕</RadioButton>
                  </RadioGroup>
                </Col>
                <Col xl={24} lg={24} md={24} sm={24} xs={24} >
                  <Card>
