  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if (
          reportFilelist.length >= 1 &&
          dogInfor.medicalReportName !== 'none' &&
          dogInfor.medicalReportName == reportFilelist[0].name
        ) {
              ...
              <Col xxl={16} xl={22} lg={24} md={24} sm={24} xs={24}>
                <Form className="ant-advanced-search-form">
                  ...
                  <Row gutter={24}>
                    ...
                    <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                      <FormItem label="犬舍" {...secondLayout}>
                        <Button disabled={disabled} onClick={this.getAllHouse}>
                          {this.state.roomName || this.state.roomIdName}
                        </Button>
                      </FormItem>
                    </Col>
                  </Row>
                  <Row gutter={24}>
                    ...
                    <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                      ...
                      <FormItem label="直系亲属" {...secondLayout}>
                        <Button disabled={disabled} onClick={this.getParentIds}>
                          {this.state.fatherId && this.state.fatherId.toString().length > 0
                            ? '父：' + (this.state.fatherName + '-' + this.state.fatherId)
                            : '父：-'}
                          ，
                          {this.state.motherId && this.state.motherId.toString().length > 0
                            ? '母：' + (this.state.motherName + '-' + this.state.motherId)
                            : '母：-'}
                        </Button>
                      </FormItem>
                    </Col>
                  ...
                  >
                    ...
                    <FormItem>
                      <span>查询：</span>
                      <Radio.Group name="radiogroup" defaultValue={1} onChange={this.switchParentSource}>
