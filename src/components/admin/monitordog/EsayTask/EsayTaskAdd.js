                                  ...
                                  <Row gutter={24}>
                                        ...
                                        <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                                            <FormItem label='人员: ' {...firstLayout}  labelCol={{span: 6}}>
                                                ...
                                                initialValue:this.state.peoValue || ""
                                                    ...
                                                    >
                                                    <Input placeholder="请选择队员" value={this.state.peoValue} disabled={true} addonBefore={<Icon type="plus" style={{ cursor: 'pointer' }} onClick={this.addPeople.bind(this)} />} />
                                                    </Tooltip>
                                                )}
                                            </FormItem>
							            </Col>     
                                    ...
                                    <Row gutter={24}>
                                        <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                                            <FormItem label='任务描述：' {...firstLayout} labelCol={{span: 6}} >
                                                ...
                                                rules: [{ required: true, message: '请输入任务描述' },{ max: 1000, message: '任务描述：长度不超过1000' }],
                                    ...
                                    <Row>
                                        <Col span={24} style={{ textAlign: 'center',marginTop:'40px' }}>
                                            <Button type="primary" htmlType='submit' onClick={() => this.handleSubmit()}>发布</Button>
                                            <Button style={{ marginLeft: 10 }} onClick={this.handleReset}>清空</Button>
                                        </Col>
                                    </Row> 
