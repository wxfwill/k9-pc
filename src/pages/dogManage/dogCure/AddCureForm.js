        ...
        this.setState(
          ...
          () => {
            this.state.cureDataSource &&
              this.state.cureDataSource.map((item, index) => {
                item.editable = true;
              });
          }
        );
      ...
      render: (text, record, index) => {
        return (
          <div className="editable-row-operations">
            {
              <Button size="small" onClick={() => this.deleteCureRecord(record.key)}>
                删除
              </Button>
            }
          </div>
                  ...
                  <Col xxl={16} xl={24} lg={24} md={24} sm={24} xs={24}>
                    <div className="baseDataTable">
                      ...
                      <Row>
                        ...
                        <Col span={6}>出生日期</Col>
                        <Col span={6}>
                          {dogInfo && dogInfo.birthday ? moment(dogInfo.birthday).format('YYYY-MM-DD') : '暂无数据'}
                        </Col>
                      </Row>
                      <Row>
                        <Col span={6}>犬只品种</Col>
