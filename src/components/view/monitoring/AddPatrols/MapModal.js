...
class MapModal extends Component {
  ...
  handleUpdate = () => {
    ...
    if (hasCreat) {
      ...
      tempCoord.latLngArr =
        typeof tempCoord.latLngArr === 'object' ? tempCoord.latLngArr : JSON.parse(tempCoord.latLngArr);
      this.setState({drawShapeDTO: tempCoord});
      if (tempCoord) {
        const tempCoordArr = tempCoord.latLngArr;
        const targetArr = [];
  ...
  handleSure() {
    ...
    if (coordMsg instanceof Object) {
      ...
      const address = this.mapObj.resolveLatLng(drawShapeDTO.coord, function (address) {
            ...
            <Card title={'添加巡逻地点'}>
              <div className="container" id="container">
                <Card
                  ...
                  bordered={false}
                  bordered
                  style={{width: 280, position: 'absolute', top: '0', right: '0', zIndex: '9999'}}>
